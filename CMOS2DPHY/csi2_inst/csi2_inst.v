...
parameter        CLK_MODE = "HS_ONLY",
  ...
  parameter  WC             = 2560,          // 16-bit Word Count in DPHY packet
  parameter DSI_FORMAT      = 0,
  parameter	WORD_WIDTH      = 8,
  // Parameters of Mixel TX DPHY PLL
  parameter CM          = 8'd208,    // (640 <= (pix_clk/(N*O))*M) <= 1500)                                              
  parameter CN          = 5'd14,    // (25 <= pix_clk/N <= 30)                                            
  parameter CO          = 2'd1,    // Refer to Mixel PLL Specs for valid values                                   
  parameter TX_FREQ_TGT	  = 74,  // Setting this parameter does not mean that design will 
